const filterButtons = document.querySelectorAll(".fragrance-categories a");
const products = document.querySelectorAll(".fragrance-product");
...
favoriteIcons.forEach(icon => {
    ...
    const productId = icon.closest(".fragrance-product").querySelector("h3").textContent.trim().toLowerCase().replace(/[^a-z0-9]+/g, "-");
...
const cartButtons = document.querySelectorAll(".fragrance-product button");
...
cartButtons.forEach(button => {
    button.addEventListener("click", () => {
        const product = button.closest(".fragrance-product");
