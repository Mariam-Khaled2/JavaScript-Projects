const filterButtons = document.querySelectorAll(".accessories-categories a");
const products = document.querySelectorAll(".accessories-product");
...
favoriteIcons.forEach(icon => {
    ...
    const productId = icon.closest(".accessories-product").querySelector("h3").textContent.trim().toLowerCase().replace(/[^a-z0-9]+/g, "-");
...
const cartButtons = document.querySelectorAll(".accessories-product button");
...
cartButtons.forEach(button => {
    button.addEventListener("click", () => {
        const product = button.closest(".accessories-product");
